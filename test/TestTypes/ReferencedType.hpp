...
{
   template<>
   struct ConverterFrom<RT, Types<Anyness::Text>> {
      LANGULUS_MORPHISM(RT, Types<Anyness::Text>);
   ...
   template<>
   struct ConverterFrom<RT, Types<Anyness::Bytes>> {
      LANGULUS_MORPHISM(RT, Types<Anyness::Bytes>);
